...
import 'package:onecredit/EmicalculatorWidget/Emicalculator.dart';
import 'package:onecredit/Loginwidget/Loginpage.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:onecredit/ServiceWidget/ServiceWidget.dart';
    ...
    children: [
      IconButton(onPressed: (){}, icon: Icon(Icons.refresh),iconSize: 20,),
              ...
              IconButton(onPressed: (){
                ...
                storage.setItem('bool_value', finalbool);
    
                
              }, icon: Icon(finalbool ? _iconDark : _iconLight))
    ],
            )
          ],
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => ServiceWidget(),));
      },
    )
