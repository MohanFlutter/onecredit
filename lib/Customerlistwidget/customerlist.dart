...
class _CustomerlistState extends State<Customerlist> {
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('Customer Details : ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17),),
  ...
  itemBuilder: (BuildContext context, int index) {
    ...
    // );
                ...
                Text('Total No.of Customer : 8',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17),)
              ],
            ),
          ),
      ),
